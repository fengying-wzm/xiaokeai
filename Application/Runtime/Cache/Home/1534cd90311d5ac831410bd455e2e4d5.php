...
<html lang="zh-CN">
  <head>
	...
	<!-- <link rel="stylesheet" href="/Public/js/multiselect/bootstrap-multiselect.css" type="text/css"/> -->
  ...
  <body>
	...
	<div class="container main">
		<div class="row">
			...
			<div class="col-md-10 ">
				<div class="admin-top">
					<span class="admin-top-title">游戏（共<?php echo ($totalRows); ?>条记录）</span><button onclick="window.location.href='/index.php/Home/Admin/game_new';" type="button" class="btn btn-primary">发布新的</button><button type="button" onclick="showLabel();"  class="btn btn-primary">设置标签</button>
	...
	<script type="text/javascript">
		...
		$(function () {
			gridObj = $.fn.bsgrid.init('searchTable', {
				url: '/index.php/Home/Admin/game_list',
				// autoLoad: false,
				pageSizeSelect: true,
				pageSize: 10,
