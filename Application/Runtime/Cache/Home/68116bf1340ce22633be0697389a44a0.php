  ...
  <body>
	...
	<script type="text/javascript">
		...
		function delAll(id){
			...
			$.ajax({
		        url: '/Home/Admin/deleteAllarticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function publishAll(id){
			var id = gridObj.getCheckedValues('id');
			$.ajax({
		        url: '/Home/Admin/publishAllarticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function cancelAll(){
			var id = gridObj.getCheckedValues('id');
			$.ajax({
		        url: '/Home/Admin/cancelAllarticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function showUrl(id){
			showAlert("查看链接地址","<a>http://www.xka100.cn/Home/Index/wechat_detail?id="+id);
		}
		
		
		function showImg(id){
			var url = "http://www.xka100.cn/Home/Index/wechat_detail?id="+id;
			showAlert("查看二维码","<div style='padding-left:180px;text-align:center;' id='myCode' ></div><div style='padding-left:100px;'><a href='"+url+"' >"+url+"</a></div>");
			//生成二维码
		...
		function operate(record, rowIndex, colIndex, options) {
			...
			var id = record['id'];
			if(status=='1'){
				return '<a class="grid-btn" href="#" onclick="showImg('+id+');" >二维码</a>&nbsp;&nbsp;<a class="grid-btn" href="/Home/Admin/wechat_detail?id='+id+'" >查看编辑</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="del('+gridObj.getRecordIndexValue(record, 'id')+');">删除</a>';
			}else{
