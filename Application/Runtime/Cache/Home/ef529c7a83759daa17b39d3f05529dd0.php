  ...
  <body>
	...
	<div class="container main">
		<div class="row">
			...
			<div class="col-md-10 ">
				<div class="admin-top">
					<span class="admin-top-title">美文详情</span>
				</div>
				...
				<div class="admin-edit">
					<form class="form-horizontal" role="form">
					   <div class="form-group">
						...
						<div class="form-group">
						      <label for="lastname" class="col-sm-1 control-label">正文：</label>
						       <div class="col-sm-10">
								<textarea id='textarea1' style='height:800px; max-height:1000px;'>
					   ...
					   <div class="form-group btn-submit">
					      ...
					      <div class="col-sm-2">
					         <button type="button"  onclick="window.location.href='/GetHot/index.php/Home/Admin/article';" class="btn btn-default btn-block">取消</button>
					      </div>
