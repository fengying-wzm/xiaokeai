		...
		<div class="row">
			...
			<div class="col-md-2 catalog_left">
				...
				<div class="btn-group-vertical btn-groups btn-group-lg">
				    ...
				    <button type="button" onclick="window.location.href='about';"  class="btn btn-default active ">关于</button>
			...
			<div class="col-md-10 ">
				<div class="admin-top">
					<span class="admin-top-title">关于（共<?php echo ($totalRows); ?>条记录）</span><button onclick="window.location.href='/index.php/Home/Admin/about_new';" type="button" class="btn btn-primary">发布新的</button><button type="button"  onclick="showLabel();" class="btn btn-primary">设置标签</button>
				</div>
	      ...
	      <div class="modal-content">
	         ...
	         <div class="modal-body" id="alertcontent">
						    	...
						    	<div class="tagsinput-primary">
					          	...
					          	提示：可以使用逗号隔开标签快速设置，如：标签1,标签2,标签3
	         </div>
	         <div class="modal-footer">
	...
	<script type="text/javascript">
		...
		$(function () {
			gridObj = $.fn.bsgrid.init('searchTable', {
				url: '/index.php/Home/Admin/about_list',
				// autoLoad: false,
				pageSizeSelect: true,
				pageSize: 10,
		...
		function operate(record, rowIndex, colIndex, options) {
			...
			var id = record['id'];
			if(status=='1'){
				return '<a class="grid-btn" href="about_detail?id='+id+'" >查看</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="cancel('+gridObj.getRecordIndexValue(record, 'id')+');" >撤回</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="del('+gridObj.getRecordIndexValue(record, 'id')+');">删除</a>';
			}else{

				return '<a class="grid-btn"  href="about_detail?id='+id+'">查看</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="publish('+gridObj.getRecordIndexValue(record, 'id')+');" >发布</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="del('+gridObj.getRecordIndexValue(record, 'id')+');">删除</a>';
			}
