  ...
  <body>
	...
	<div class="container main">
		<div class="row">
			...
			<div class="col-md-10 ">
				<div class="admin-top">
					<span class="admin-top-title">体育（共<?php echo ($totalRows); ?>条记录）</span><button onclick="window.location.href='/index.php/Home/Admin/sport_new';" type="button" class="btn btn-primary">发布新的</button><button type="button" onclick="showLabel();" class="btn btn-primary">设置标签</button>
				</div>
	...
	<script type="text/javascript">
		...
		$(function () {
			gridObj = $.fn.bsgrid.init('searchTable', {
				url: '/index.php/Home/Admin/sport_list',
				// autoLoad: false,
				pageSizeSelect: true,
				pageSize: 10,
		...
		function del(id){
			$.ajax({
		        url: '/index.php/Home/Admin/delete',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function publish(id){
			$.ajax({
		        url: '/index.php/Home/Admin/publish',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function cancel(id){
			$.ajax({
		        url: '/index.php/Home/Admin/cancel',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function delAll(id){
			...
			$.ajax({
		        url: '/index.php/Home/Admin/deleteAll',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function publishAll(id){
			var id = gridObj.getCheckedValues('id');
			$.ajax({
		        url: '/index.php/Home/Admin/publishAll',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function cancelAll(){
			var id = gridObj.getCheckedValues('id');
			$.ajax({
		        url: '/index.php/Home/Admin/cancelAll',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function operate(record, rowIndex, colIndex, options) {
			...
			var id = record['id'];
			if(status=='1'){
				return '<a class="grid-btn" href="sport_detail?id='+id+'" >查看</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="cancel('+gridObj.getRecordIndexValue(record, 'id')+');" >撤回</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="del('+gridObj.getRecordIndexValue(record, 'id')+');">删除</a>';
			}else{

				return '<a class="grid-btn"  href="sport_detail?id='+id+'">查看</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="publish('+gridObj.getRecordIndexValue(record, 'id')+');" >发布</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="del('+gridObj.getRecordIndexValue(record, 'id')+');">删除</a>';
			}
