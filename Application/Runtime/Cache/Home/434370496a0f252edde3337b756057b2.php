...
<link href="//cdn.bootcss.com/bootstrap-multiselect/0.9.10/css/bootstrap-multiselect.css" rel="stylesheet">
  ...
  <body>
	...
	<nav class="navbar navbar-inverse" style="border-radius:0;" role="navigation">
		<div class="container header">
		   <div class="navbar-header ">
			  <a class="navbar-brand" href="index.html">纸落云烟</a>
		   </div>
		  <div class="user">
		...
		<div class="row">
			...
			<div class="col-md-2 catalog_left">
				...
				<div class="btn-group-vertical btn-groups btn-group-lg">
				    ...
				    <button type="button" onclick="window.location.href='wechat';"  class="btn btn-default active">微信文章</button>
				</div>
			...
			<div class="col-md-10 ">
				<div class="admin-top">
					<span class="admin-top-title">微信文章（共<?php echo ($totalRows); ?>条记录）</span><button onclick="window.location.href='/Home/Admin/wechat_new';" type="button" class="btn btn-primary">发布新的</button>
				</div>
	...
	<script type="text/javascript">
		...
		function showUrl(id){
			showAlert("查看链接地址","<a>http://www.gethot.cn/GetHot/index.php/Home/Index/wechat_detail?id="+id);
		}
		
		
		function showImg(id){
			showAlert("查看链接地址","http://www.gethot.cn/GetHot/index.php/Home/Index/wechat_detail?id="+id+"</a>");
		}
		...
		function operate(record, rowIndex, colIndex, options) {
			...
			var id = record['id'];
			if(status=='1'){
				return '<a class="grid-btn" href="#" onclick="showUrl('+id+');" >查看链接</a>&nbsp;&nbsp;<a class="grid-btn" href="/Home/Admin/wechat_detail?id='+id+'" >编辑</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="del('+gridObj.getRecordIndexValue(record, 'id')+');">删除</a>';
			}else{
