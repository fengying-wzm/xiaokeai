  ...
  <body>
	...
	<div class="container main">
		<div class="row">
			...
			<div class="col-md-10 ">
				<div class="admin-top">
					<span class="admin-top-title">关于详情</span>
				</div>
					...
					<form class="form-horizontal" role="form">
					   <div class="form-group">
						...
						<div class="form-group">
						      ...
						      <div class="col-sm-10">
						         <input type="text" class="form-control"  value="" id="author"
					            placeholder="请输入作者">
						      </div>
					   	</div>
					   ...
					   <div class="form-group btn-submit">
					      ...
					      <div class="col-sm-2">
					         <button type="button"  onclick="window.location.href='/GetHot/index.php/Home/Admin/about';" class="btn btn-default btn-block">取消</button>
					      </div>
	...
	<script>
		...
		function save(){
			...
			if(content==null||content.length==0){
		      ...
		      $.ajax({
		        url: '/GetHot/index.php/Home/Admin/about_add',
		      //  dataType: 'json',
		        type: 'POST',
		        data: {author:author,title:title,tags:tags,content:content},
