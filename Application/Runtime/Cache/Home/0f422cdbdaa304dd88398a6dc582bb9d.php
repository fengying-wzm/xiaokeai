		...
		<div class="row index-row">
			...
			<div class="col-md-7 ">
				<div class="catalog_sport">
					...
					<?php if(is_array($sportList)): $i = 0; $__LIST__ = array_slice($sportList,0,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["type"] == '1' ): ?><div class="sport-date"><span><?php echo ($vo["title"]); ?></span></div>
						<?php else: ?> 
