				...
				<div class="admin-edit">
					<form class="form-horizontal" role="form">
					   ...
					   <div class="form-group btn-submit">
					      ...
					      <div class="col-sm-2">
					         <button type="button"  onclick="window.location.href='/index.php/Home/Admin/sport';" class="btn btn-default btn-block">取消</button>
					      </div>
      ...
      $('input.tagsinput').tagsinput();
		...
		function save(){
			...
			for(var i=0;i<urls.length;i++){
		      ...
		      $.ajax({
		        url: '/index.php/Home/Admin/sport_update',
		      //  dataType: 'json',
		        method: 'POST',
