                            ...
                            <div class="form-bottom">
			                    <div   class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" id="userCode" placeholder="输入用户名" class="form-username form-control"  >
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">密码</label>
			                        	<input type="password" id="loginPwd" placeholder="输入登录密码" class="form-password form-control"  >
			                        </div>
			      ...
			      $("#login").click(function(){
			    	  var userCode = $("#userCode").val();
						...
						$.ajax({
				             ...
				             data: {userCode:userCode , loginPwd:loginPwd},
				             dataType: "json",
