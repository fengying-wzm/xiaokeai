...
<link href="//cdn.bootcss.com/bootstrap-multiselect/0.9.10/css/bootstrap-multiselect.css" rel="stylesheet">
  ...
  <body>
		...
		<div class="row">
			...
			<div class="col-md-2 catalog_left">
				...
				<div class="btn-group-vertical btn-groups btn-group-lg">
				    ...
				    <button type="button" onclick="window.location.href='article';"  class="btn btn-default active">美文</button>
			...
			<div class="col-md-10 ">
				<div class="admin-top">
					<span class="admin-top-title">美文（共<?php echo ($totalRows); ?>条记录）</span><button onclick="window.location.href='/index.php/Home/Admin/article_new';" type="button" class="btn btn-primary">发布新的</button><button type="button"  onclick="showLabel();" class="btn btn-primary">设置标签</button>
				</div>
					...
					<div class="admin-grid-content">
						<table id="searchTable">
							<tr>
								...
								<th w_index="author" width="15%;">作者</th>
	...
	<!-- <script type="text/javascript" src="/Public/js/multiselect/bootstrap-multiselect.min.js"></script> -->
	...
	<script>
      ...
      $('input.tagsinput').tagsinput();
		...
		function saveTags(){
			var tags = $('#remarks').html();
			//if(tags==null||tags.length==0){
			//	showAlert("提示","标签不能为空");
			//	return;
			//}
		      $.ajax({
		        url: '/index.php/Home/Admin/saveTags',
		      //  dataType: 'json',
		        type: 'POST',
		        data: {tags:tags,type:'2'},
	...
	<script type="text/javascript">
		...
		$(function () {
			gridObj = $.fn.bsgrid.init('searchTable', {
				url: '/index.php/Home/Admin/article_list',
				// autoLoad: false,
				pageSizeSelect: true,
				pageSize: 10,
		...
		function del(id){
			$.ajax({
		        url: '/index.php/Home/Admin/deletearticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function publish(id){
			$.ajax({
		        url: '/index.php/Home/Admin/publisharticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function cancel(id){
			$.ajax({
		        url: '/index.php/Home/Admin/cancelarticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function delAll(id){
			...
			$.ajax({
		        url: '/index.php/Home/Admin/deleteAllarticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function publishAll(id){
			var id = gridObj.getCheckedValues('id');
			$.ajax({
		        url: '/index.php/Home/Admin/publishAllarticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function cancelAll(){
			var id = gridObj.getCheckedValues('id');
			$.ajax({
		        url: '/index.php/Home/Admin/cancelAllarticle',
		      //  dataType: 'json',
		        method: 'POST',
		        data: {id:id},
		        success: function(data , textStatus){
		...
		function operate(record, rowIndex, colIndex, options) {
			...
			var id = record['id'];
			if(status=='1'){
				return '<a class="grid-btn" href="article_detail?id='+id+'" >查看</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="cancel('+gridObj.getRecordIndexValue(record, 'id')+');" >撤回</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="del('+gridObj.getRecordIndexValue(record, 'id')+');">删除</a>';
			}else{

				return '<a class="grid-btn"  href="article_detail?id='+id+'">查看</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="publish('+gridObj.getRecordIndexValue(record, 'id')+');" >发布</a>&nbsp;&nbsp;<a  class="grid-btn" href="#" onclick="del('+gridObj.getRecordIndexValue(record, 'id')+');">删除</a>';
			}
